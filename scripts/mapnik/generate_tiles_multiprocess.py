...
if __name__ == "__main__":
    ...
    try:
        ...
        mapfile = sys.argv[1]
        #mapfile = "osm-places-boundaries.xml"
    try:
        tile_dir = os.environ['MAPNIK_TILE_DIR']
    except KeyError:
        tile_dir = sys.argv[2]
        #tile_dir = "/tiles/osm-places-boundaries/"

    if not tile_dir.endswith('/'):
        tile_dir = tile_dir + '/'

    bbox = (8.782379, 46.358770, 17.189532, 49.037872)
    minZoom = int(sys.argv[3])
    maxZoom = int(sys.argv[4])
    render_tiles(bbox, mapfile, tile_dir, minZoom, maxZoom, "Austria")
